          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            {corePhilosophy.map((item, index) => (
              <motion.div
                ...
                className="text-center bg-white dark:bg-gray-700 p-6 sm:p-8 rounded-lg shadow-md"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {expertiseData.map((skill, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`p-4 sm:p-6 rounded-lg shadow-sm flex flex-col ${skill.bgColor}`}
              >
                {skill.image ? (
                  <div className="mb-4 sm:mb-6 h-32 sm:h-40 md:h-48 overflow-hidden rounded-md bg-white dark:bg-gray-800 p-2 sm:p-4 flex items-center justify-center">
                    <img
                      src={skill.image}
                      alt={skill.name}
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">
                  {skill.name}
                </h3>
